...
TASKS = [
    ...
    ("4. CI/CD Pipeline", "Helm charts for app1 + app2 deployment",                  "Complete", 100, "values.yaml in Git is safe sandbox stub; real values.yaml dynamically loaded from Azure Key Vault"),
